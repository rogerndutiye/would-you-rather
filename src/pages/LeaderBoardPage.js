...
<div className="flex bg-white shadow-2xl mb-4 border border-gray-300 rounded p-3" key={user.id}>
...
<div className="w-2/12 flex flex-col px-2 text-center items-center justify-center">
  ...
  <div className="mt-5 bg-green-600 text-white text-bold text-xl rounded-full h-10 w-10 flex items-center justify-center">{user.score}</div>
</div>
</div>
          ))}
